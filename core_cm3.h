 ...
 */
 ...
 typedef struct {
     ...
     uint32_t RESERVED0[24];
     __IO uint32_t
         ICER[8]; /*!< Offset: 0x080  Interrupt Clear Enable Register         */
     uint32_t RSERVED1[24];
     __IO uint32_t ISPR[8]; /*!< Offset: 0x100  Interrupt Set Pending Register */
     uint32_t RESERVED2[24];
     __IO uint32_t
         ICPR[8]; /*!< Offset: 0x180  Interrupt Clear Pending Register        */
     ...
     __O uint32_t
         STIR; /*!< Offset: 0xE00  Software Trigger Interrupt Register     */
 } NVIC_Type;
 ...
 typedef struct {
     ...
     __IO uint32_t AIRCR;  /*!< Offset: 0x0C  Application Interrupt / Reset
                              Control Register        */
 ...
 typedef struct {
     __IO uint32_t
         CTRL; /*!< Offset: 0x00  SysTick Control and Status Register */
 ...
 #define MPU_RASR_ENA_Msk \
     (0x1Ful              \
      << MPU_RASR_ENA_Pos) /*!< MPU RASR: Region enable bit Disable Mask */
 ...
 typedef struct {
     ...
     __IO uint32_t DEMCR; /*!< Offset: 0x0C  Debug Exception and Monitor Control
                             Register */
 } CoreDebug_Type;
