...
static char *const Stack_reg[] = {"R0",  "R1", "R2", "R3",
                                  "R12", "LR", "RA", "xPSR"};
...
static void Fault_Report(unsigned int lr, unsigned int *msp, unsigned int *psp,
                         unsigned int psr) {
    ...
    switch ((lr & (0xF << 28)) | (lr & 0xF)) {
        case 0xF0000001:
            Uart1_Printf("Handler(MSP)\n");
            Stack_Dump("MSP", msp);
            break;
        case 0xF0000009:
            Uart1_Printf("Thread(MSP)\n");
            Stack_Dump("MSP", msp);
            break;
        case 0xF000000d:
            Uart1_Printf("Thread(PSP)\n");
            Stack_Dump("PSP", psp);
            break;
        default:
...
void HardFault_Handler(unsigned int lr, unsigned int *msp, unsigned int *psp,
                       unsigned int psr) {
...
void MemManage_Handler(unsigned int lr, unsigned int *msp, unsigned int *psp,
                       unsigned int psr) {
...
void BusFault_Handler(unsigned int lr, unsigned int *msp, unsigned int *psp,
                      unsigned int psr) {
...
void UsageFault_Handler(unsigned int lr, unsigned int *msp, unsigned int *psp,
                        unsigned int psr) {
