 ...
 */
 ...
 #define RCC_CFGR_PLLSRC_PREDIV1                                           \
     ((uint32_t)0x00010000) /*!< PREDIV1 clock selected as PLL entry clock \
                               source */
 ...
 #define RCC_CFGR_MCO_PLL3CLK_Div2                                       \
     ((uint32_t)0x09000000) /*!< PLL3 clock divided by 2 selected as MCO \
                               source*/
 #define RCC_CFGR_MCO_Ext_HSE                                           \
     ((uint32_t)0x0A000000) /*!< XT1 external 3-25 MHz oscillator clock \
 ...
 #define RCC_BDCR_RTCSEL_HSE                                                 \
     ((uint32_t)0x00000300) /*!< HSE oscillator clock divided by 128 used as \
                               RTC clock */
 ...
 #define GPIO_CRH_CNF10                                                      \
     ((uint32_t)0x00000C00) /*!< CNF10[1:0] bits (Port x configuration bits, \
                               pin 10) */
 #define GPIO_CRH_CNF10_0 ((uint32_t)0x00000400) /*!< Bit 0 */
 #define GPIO_CRH_CNF10_1 ((uint32_t)0x00000800) /*!< Bit 1 */
 
 #define GPIO_CRH_CNF11                                                      \
     ((uint32_t)0x0000C000) /*!< CNF11[1:0] bits (Port x configuration bits, \
                               pin 11) */
 #define GPIO_CRH_CNF11_0 ((uint32_t)0x00004000) /*!< Bit 0 */
 #define GPIO_CRH_CNF11_1 ((uint32_t)0x00008000) /*!< Bit 1 */
 
 #define GPIO_CRH_CNF12                                                      \
     ((uint32_t)0x000C0000) /*!< CNF12[1:0] bits (Port x configuration bits, \
                               pin 12) */
 #define GPIO_CRH_CNF12_0 ((uint32_t)0x00040000) /*!< Bit 0 */
 #define GPIO_CRH_CNF12_1 ((uint32_t)0x00080000) /*!< Bit 1 */
 
 #define GPIO_CRH_CNF13                                                      \
     ((uint32_t)0x00C00000) /*!< CNF13[1:0] bits (Port x configuration bits, \
                               pin 13) */
 #define GPIO_CRH_CNF13_0 ((uint32_t)0x00400000) /*!< Bit 0 */
 #define GPIO_CRH_CNF13_1 ((uint32_t)0x00800000) /*!< Bit 1 */
 
 #define GPIO_CRH_CNF14                                                      \
     ((uint32_t)0x0C000000) /*!< CNF14[1:0] bits (Port x configuration bits, \
                               pin 14) */
 #define GPIO_CRH_CNF14_0 ((uint32_t)0x04000000) /*!< Bit 0 */
 #define GPIO_CRH_CNF14_1 ((uint32_t)0x08000000) /*!< Bit 1 */
 
 #define GPIO_CRH_CNF15                                                      \
     ((uint32_t)0xC0000000) /*!< CNF15[1:0] bits (Port x configuration bits, \
                               pin 15) */
 ...
 #define AFIO_MAPR_TIM1_REMAP_NOREMAP                                    \
     ((uint32_t)0x00000000) /*!< No remap (ETR/PA12, CH1/PA8, CH2/PA9,   \
 ...
 #define AFIO_MAPR_TIM3_REMAP_FULLREMAP                                 \
     ((uint32_t)0x00000C00) /*!< Full remap (CH1/PC6, CH2/PC7, CH3/PC8, \
                               CH4/PC9) */
 ...
 #define SCB_AIRCR_SYSRESETREQ                                             \
     ((uint32_t)0x00000004) /*!< Requests chip control logic to generate a \
                               reset */
 ...
 #define SCB_AIRCR_PRIGROUP6                                            \
     ((uint32_t)0x00000600) /*!< Priority group=6 (1 bit of pre-emption \
                               priority, 7 bits of subpriority) */
 ...
 #define SCB_CCR_NONBASETHRDENA                                           \
     ((uint16_t)0x0001) /*!< Thread mode can be entered from any level in \
 ...
 #define SCB_CCR_USERSETMPEND                                                \
     ((uint16_t)0x0002) /*!< Enables user code to write the Software Trigger \
                           Interrupt register to trigger (pend) a Main       \
                           exception */
 ...
 #define SCB_CFSR_UNALIGNED                                                    \
     ((uint32_t)0x01000000) /*!< Fault occurs when there is an attempt to make \
 ...
 #define EXTI_RTSR_TR0                                                          \
     ((uint32_t)0x00000001) /*!< Rising trigger event configuration bit of line \
                               0 */
 #define EXTI_RTSR_TR1                                                          \
     ((uint32_t)0x00000002) /*!< Rising trigger event configuration bit of line \
                               1 */
 #define EXTI_RTSR_TR2                                                          \
     ((uint32_t)0x00000004) /*!< Rising trigger event configuration bit of line \
                               2 */
 #define EXTI_RTSR_TR3                                                          \
     ((uint32_t)0x00000008) /*!< Rising trigger event configuration bit of line \
                               3 */
 #define EXTI_RTSR_TR4                                                          \
     ((uint32_t)0x00000010) /*!< Rising trigger event configuration bit of line \
                               4 */
 #define EXTI_RTSR_TR5                                                          \
     ((uint32_t)0x00000020) /*!< Rising trigger event configuration bit of line \
                               5 */
 #define EXTI_RTSR_TR6                                                          \
     ((uint32_t)0x00000040) /*!< Rising trigger event configuration bit of line \
                               6 */
 #define EXTI_RTSR_TR7                                                          \
     ((uint32_t)0x00000080) /*!< Rising trigger event configuration bit of line \
                               7 */
 #define EXTI_RTSR_TR8                                                          \
     ((uint32_t)0x00000100) /*!< Rising trigger event configuration bit of line \
                               8 */
 #define EXTI_RTSR_TR9                                                          \
     ((uint32_t)0x00000200) /*!< Rising trigger event configuration bit of line \
                               9 */
 ...
 #define EXTI_FTSR_TR0                                                      \
     ((uint32_t)0x00000001) /*!< Falling trigger event configuration bit of \
                               line 0 */
 ...
 #define ADC_CR1_AWDCH                                                    \
     ((uint32_t)0x0000001F) /*!< AWDCH[4:0] bits (Analog watchdog channel \
                               select bits) */
 ...
 #define ADC_CR1_AWDSGL                                                     \
     ((uint32_t)0x00000200) /*!< Enable the watchdog on a single channel in \
                               scan mode */
 ...
 #define ADC_SMPR2_SMP0                                                \
     ((uint32_t)0x00000007) /*!< SMP0[2:0] bits (Channel 0 Sample time \
                               selection) */
 ...
 #define ADC_SMPR2_SMP1                                                \
     ((uint32_t)0x00000038) /*!< SMP1[2:0] bits (Channel 1 Sample time \
                               selection) */
 ...
 #define ADC_SMPR2_SMP2                                                \
     ((uint32_t)0x000001C0) /*!< SMP2[2:0] bits (Channel 2 Sample time \
                               selection) */
 ...
 #define ADC_SMPR2_SMP3                                                \
     ((uint32_t)0x00000E00) /*!< SMP3[2:0] bits (Channel 3 Sample time \
                               selection) */
 ...
 #define ADC_SMPR2_SMP4                                                \
     ((uint32_t)0x00007000) /*!< SMP4[2:0] bits (Channel 4 Sample time \
                               selection) */
 ...
 #define ADC_SMPR2_SMP5                                                \
     ((uint32_t)0x00038000) /*!< SMP5[2:0] bits (Channel 5 Sample time \
                               selection) */
 ...
 #define ADC_SMPR2_SMP6                                                \
     ((uint32_t)0x001C0000) /*!< SMP6[2:0] bits (Channel 6 Sample time \
                               selection) */
 ...
 #define ADC_SMPR2_SMP7                                                \
     ((uint32_t)0x00E00000) /*!< SMP7[2:0] bits (Channel 7 Sample time \
                               selection) */
 ...
 #define ADC_SMPR2_SMP8                                                \
     ((uint32_t)0x07000000) /*!< SMP8[2:0] bits (Channel 8 Sample time \
                               selection) */
 ...
 #define ADC_SMPR2_SMP9                                                \
     ((uint32_t)0x38000000) /*!< SMP9[2:0] bits (Channel 9 Sample time \
                               selection) */
 ...
 #define CEC_CSR_TBTRF                                                   \
     ((uint16_t)0x0008) /*!<  Tx Byte Transfer Request or Block Transfer \
                           Finished */
 ...
 #define FSMC_BTR1_ADDSET                                              \
     ((uint32_t)0x0000000F) /*!< ADDSET[3:0] bits (Address setup phase \
                               duration) */
 ...
 #define USB_COUNT0_RX_1_NUM_BLOCK_1                                      \
     ((uint32_t)0x7C000000) /*!< NUM_BLOCK_1[4:0] bits (Number of blocks) \
                               (high) */
 ...
 #define I2C_CCR_CCR                                                      \
     ((uint16_t)0x0FFF) /*!< Clock Control Register in Fast/Standard mode \
                           (Master mode) */
 ...
 #define DBGMCU_CR_DBG_IWDG_STOP                                              \
     ((uint32_t)0x00000100) /*!< Debug Independent Watchdog stopped when Core \
                               is halted */
 ...
 #define ETH_MACCR_IFG_96Bit                                                  \
     ((uint32_t)0x00000000) /* Minimum IFG between frames during transmission \
                               is 96Bit */
 ...
 #define ETH_MACCR_APCS ((uint32_t)0x00000080) /* Automatic Pad/CRC stripping \
                                                */
 #define ETH_MACCR_BL                                                       \
     ((uint32_t)0x00000060) /* Back-off limit: random integer number (r) of \
                               slot time delays before rescheduling a                                                                         \
 ...
 #define ETH_MACA1HR_MBC                                                      \
     ((uint32_t)0x3F000000) /* Mask byte control: bits to mask for comparison \
 ...
 #define ETH_MMCTIR_TGFS                                                    \
     ((uint32_t)0x00200000) /* Set when Tx good frame count counter reaches \
                               half the maximum value */
 ...
 #define ETH_MMCTGFSCCR_TGFSCC                                                 \
     ((uint32_t)0xFFFFFFFF) /* Number of successfully transmitted frames after \
                               a single collision in Half-duplex mode. */
 ...
 #define ETH_MMCTGFMSCCR_TGFMSCC                                               \
     ((uint32_t)0xFFFFFFFF) /* Number of successfully transmitted frames after \
                               more than a single collision in Half-duplex     \
                               mode. */
 ...
 #define ETH_MMCRFAECR_RFAEC                                            \
     ((uint32_t)0xFFFFFFFF) /* Number of frames received with alignment \
                               (dribble) error */
